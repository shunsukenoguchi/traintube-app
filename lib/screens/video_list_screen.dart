...
class VideoListScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return categorys.when(
      data: (categoryList) => DefaultTabController(
                    ...
                    data: (videos) {
                      final filteredVideos = videos
                        ...
                        ..sort((a, b) {
                          ...
                          return a.categorySortOrder.compareTo(b.categorySortOrder);
                        });
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Dismissible(
                                  ...
                                  onDismissed: (direction) {
                                    ref
                                        .read(videoInfosProvider.notifier)
                                        .removeVideoInfo(videoInfo.url);
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text('${videoInfo.title}を削除しました'),
